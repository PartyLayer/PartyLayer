...
interface SendStatusResponse { kernel: SendKernelInfo; connection?: { isConnected: boolean; }; isConnected?: boolean; isNetworkConnected: boolean; networkReason?: string; network?: SendNetwork; session?: { accessToken: string; userId: string; }; }
