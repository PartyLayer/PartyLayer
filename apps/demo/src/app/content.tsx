...
const proofItems = [
  ...
  },
  {
    ...
    description: 'Schema-validated wallet registry, published in public and served from one origin.',
  },
  {
    icon: (
      <svg width={24} height={24} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
